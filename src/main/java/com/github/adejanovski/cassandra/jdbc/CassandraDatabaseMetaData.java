...
class CassandraDatabaseMetaData implements DatabaseMetaData {
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
        ...
        if (catalog == null || connection.getCatalog().equals(catalog)) {
            ...
            ResultSet rs = MetadataResultSets.instance.makeColumns(statement, schemaPattern,
    ...
    public String getDatabaseProductVersion() throws SQLException {
        return String.format("%d.%d.%d", CassandraConnection.DB_MAJOR_VERSION,
                CassandraConnection.DB_MINOR_VERSION, CassandraConnection.DB_REVISION);
    }
    ...
    public String getDriverVersion() throws SQLException {
        return String.format("%d.%d.%d", CassandraDriver.DVR_MAJOR_VERSION,
                CassandraDriver.DVR_MINOR_VERSION, CassandraDriver.DVR_PATCH_VERSION);
    }
    ...
    public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
        ...
        if (catalog == null || connection.getCatalog().equals(catalog)) {
            ...
            ResultSet rs = MetadataResultSets.instance.makeIndexes(statement, schema, table, unique,
                    approximate);
            return rs;
        }
        return new CassandraResultSet();
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern,
        ...
        if ((catalog == null || connection.getCatalog().equals(catalog)) && askingForTable) {
            ...
            // if (schemaPattern == null) schemaPattern = connection.getSchema(); //limit to current
            // schema if set
            ResultSet rs = MetadataResultSets.instance.makeTables(statement, schemaPattern,
                    tableNamePattern);
            return rs;
        }
