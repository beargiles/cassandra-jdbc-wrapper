...
public class LongToTimestampCodec extends TypeCodec<Timestamp> {
	...
	@Override
	public ByteBuffer serialize(Timestamp paramT, ProtocolVersion paramProtocolVersion) throws InvalidTypeException {
		if (paramT == null) {
			return null;
		}
	...
	@Override
	public Timestamp deserialize(ByteBuffer paramByteBuffer, ProtocolVersion paramProtocolVersion) throws InvalidTypeException {
