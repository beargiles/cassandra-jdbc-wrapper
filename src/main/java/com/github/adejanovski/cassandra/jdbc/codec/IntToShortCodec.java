...
public class IntToShortCodec extends TypeCodec<Short> {
    ...
    @Override
    public ByteBuffer serialize(Short paramT, ProtocolVersion paramProtocolVersion)
    ...
    @Override
    public Short deserialize(ByteBuffer paramByteBuffer, ProtocolVersion paramProtocolVersion)
            throws InvalidTypeException {
